...
<head>
  ...
  <title>Scheawase - レスポンシブな出欠管理・スケジュール調整ツール！</title>
  ...
  <div class="navbar navbar-default navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        <a href="./" class="navbar-brand"><i class="fa fa-calendar-o"></i> Scheawase</a>
        ...
        <div class="wizard">
            ...
            <div class="tab-content">
                <div class="tab-pane active" role="tabpanel" id="step1">
                    <h3 class="head text-center">Scheawaseにようこそ <span style="color:#f48260;"><i class="glyphicon glyphicon-heart"></i></span></h3>
                      <p class="text-center">
                          Scheawaseはイベント・歓送迎会・忘年会・新年会・同窓会などの日程調整＆出欠確認を行うツールです。<br>無料・登録不要・使い捨て型のWebサービスです！
                      </p>
